...
enum Aerospike_list_operations {
	...
	OP_LIST_GET_BY_VALUE_REL_RANK_RANGE,
	OP_LIST_GET_BY_VALUE_REL_RANK_RANGE_TO_END,
	OP_LIST_GET_RANGE_FROM,
	OP_LIST_INCREMENT,
	OP_LIST_SET_ORDER,
	OP_LIST_SORT,
	...
	OP_LIST_REMOVE_BY_VALUE_REL_RANK_RANGE,
	OP_LIST_REMOVE_BY_VALUE_REL_RANK_RANGE_TO_END,
	OP_LIST_REMOVE_RANGE_FROM
};
