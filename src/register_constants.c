...
static AerospikeGeneralLongConstant aerospike_general_long_constants[] = {
	...
	{ OP_LIST_POP_RANGE_FROM, 		   "OP_LIST_POP_RANGE_FROM"                           },
	...
	{ OP_LIST_GET_BY_VALUE_REL_RANK_RANGE,"OP_LIST_GET_BY_VALUE_REL_RANK_RANGE"           },
	{ OP_LIST_GET_BY_VALUE_REL_RANK_RANGE_TO_END,"OP_LIST_GET_BY_VALUE_REL_RANK_RANGE_TO_END"},
	{ OP_LIST_GET_RANGE_FROM,          "OP_LIST_GET_RANGE_FROM"                           },
	...
	{ OP_LIST_REMOVE_BY_VALUE_REL_RANK_RANGE, "OP_LIST_REMOVE_BY_VALUE_REL_RANK_RANGE"    },
	{ OP_LIST_REMOVE_BY_VALUE_REL_RANK_RANGE_TO_END, "OP_LIST_REMOVE_BY_VALUE_REL_RANK_RANGE_TO_END"},
	{ OP_LIST_REMOVE_RANGE_FROM, 	   "OP_LIST_REMOVE_RANGE_FROM"                        },
