...
PHP_INI_BEGIN()
    ...
    STD_PHP_INI_ENTRY("aerospike.shm.key", "0xA6000000", PHP_INI_PERDIR|PHP_INI_SYSTEM|PHP_INI_USER, OnUpdateLong, shm_key, zend_aerospike_globals, aerospike_globals)
